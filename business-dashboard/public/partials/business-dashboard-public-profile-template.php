        ...
        <div class="business-dashboard-profile-view public-profile">
            ...
            <div class="business-dashboard-tabs-wrap">
                <h2 class="nav-tab-wrapper">
                    ...
                    <a href="#products-listings" class="nav-tab" data-tab="products-listings"><?php _e( 'Products & Listings', 'business-dashboard' ); ?></a>
                    <a href="#product-gallery" class="nav-tab" data-tab="product-gallery"><?php _e( 'Product Gallery', 'business-dashboard' ); ?></a>
                ...
                <div class="business-dashboard-tab-content" id="products-listings-tab" style="display:none;">
                    <h3><?php _e( 'Our Products & Listings', 'business-dashboard' ); ?></h3>
                    <?php echo $public_class->display_published_products_grid( $user_id ); ?>
                </div>

                <div class="business-dashboard-tab-content" id="product-gallery-tab" style="display:none;">
                    <h3><?php _e( 'Our Product Gallery', 'business-dashboard' ); ?></h3>
                    <?php
                    ...
                    $business_posts_gallery = new WP_Query( $args );
                    ?>
                    <div class="business-dashboard-product-gallery-grid">
                        <?php if ( $business_posts_gallery->have_posts() ) : ?>
                            <?php while ( $business_posts_gallery->have_posts() ) : $business_posts_gallery->the_post();
...
<script>
    jQuery(document).ready(function($) {
        ...
        $(document).on('click', '.business-dashboard-profile-view.public-profile .nav-tab-wrapper .nav-tab', function(e) {
            ...
            $('#' + targetTab + '-tab').show();
            initLazyLoad(); // Initialize lazy load for new tab content
        });
        ...
        initLazyLoad(); // Initial lazy load for the default tab
    });
</script>
